...
const vueTestUtils = (function (Vue, vueTemplateCompiler) {
  // var Vue = require('vue');
  ...
  var VUE_VERSION = Number(
    Vue__default["default"].version.split(".")[0] +
      "." +
      Vue__default["default"].version.split(".")[1]
  );
  ...
  function addMocks(_Vue, mockedProperties) {
    ...
    Object.keys(mockedProperties).forEach(function (key) {
      ...
      // $FlowIgnore
      Vue__default["default"].util.defineReactive(
        _Vue,
        key,
        mockedProperties[key]
      );
    });
  }
  ...
  function addStubs(_Vue, stubComponents) {
    ...
    _Vue.mixin(
      ((obj = {}),
      (obj[BEFORE_RENDER_LIFECYCLE_HOOK] = addStubComponentsMixin),
      obj)
    );
  }
    ...
    var loop = function (scopedSlotName) {
      ...
      var renderFn =
        typeof slot === "function"
          ? slot
          : vueTemplateCompiler.compileToFunctions(scopedSlotMatches.slot, {
              warn: customWarn,
            }).render;
        ...
        return h(
          ...
          context
            ...
            : this.$options._renderChildren ||
                getScopedSlotRenderFunctions(this).map(function (x) {
  ...
  function patchCreateElement(_Vue, stubs, stubAllComponents) {
    ...
    _Vue.mixin(
      ((obj = {}),
      (obj[BEFORE_RENDER_LIFECYCLE_HOOK] = patchCreateElementMixin),
      obj)
    );
  }
  ...
  function createChildren(vm, h, ref) {
    ...
    return (
      (context &&
        context.children &&
        context.children.map(function (x) {
  ...
  Tokenizer$1.prototype._is_opening = function (current_token) {
    return (
      current_token.type === TOKEN$1.START_BLOCK ||
      current_token.type === TOKEN$1.START_EXPR
    );
  };

  Tokenizer$1.prototype._is_closing = function (current_token, open_token) {
    return (
      (current_token.type === TOKEN$1.END_BLOCK ||
        current_token.type === TOKEN$1.END_EXPR) &&
      open_token &&
  ...
  // handle string
  //
  Tokenizer$1.prototype._read_string_recursive = function (
    delimiter,
  ...
  Beautifier.prototype.create_flags = function (flags_base, mode) {
    ...
    var next_flags = {
      ...
      last_token: flags_base
        ...
        : new Token$2(TOKEN$2.START_BLOCK, ""), // last token text
  ...
  Beautifier.prototype.handle_word = function (current_token) {
    ...
    if (
      reserved_array(current_token, line_starters$1) &&
      this._flags.last_token.text !== ")"
    ) {
      if (
        this._flags.inline_frame ||
  ...
  var Tokenizer$3 = function (input_string, options) {
    ...
    var templatable_reader = new TemplatablePattern$2(this._input).read_options(
      this._options
    );
  ...
  Tokenizer$3.prototype._read_attribute = function (
    c,
    previous_token,
    open_token
  ) {
  ...
  Tokenizer$3.prototype._read_raw_content = function (
    c,
    previous_token,
    open_token
  ) {
  ...
  Printer.prototype.print_preserved_newlines = function (raw_token) {
    var newlines = 0;
    if (
      raw_token.type !== TOKEN$4.TEXT &&
      raw_token.previous.type !== TOKEN$4.TEXT
    ) {
  ...
  Beautifier$4.prototype.beautify = function () {
    ...
    while (raw_token.type !== TOKEN$4.EOF) {
      if (
        ...
        raw_token.type === TOKEN$4.COMMENT
      ) {
  ...
  Beautifier$4.prototype._handle_tag_close = function (
    printer,
    raw_token,
    last_tag_token
  ) {
  ...
  Beautifier$4.prototype._handle_inside_tag = function (
    printer,
    raw_token,
    last_tag_token,
    tokens
    ...
    if (last_tag_token.is_unformatted) {
      ...
      if (raw_token.type === TOKEN$4.ATTRIBUTE) {
        ...
        raw_token.type === TOKEN$4.VALUE &&
        raw_token.previous.type === TOKEN$4.EQUALS
      ) {
  ...
  Beautifier$4.prototype._handle_text = function (
    printer,
    raw_token,
    last_tag_token
  ) {
  ...
  Beautifier$4.prototype._print_custom_beatifier_text = function (
    printer,
    raw_token,
    last_tag_token
  ) {
  ...
  Beautifier$4.prototype._handle_tag_open = function (
    printer,
    raw_token,
    last_tag_token,
    last_token
  ...
  Beautifier$4.prototype._get_tag_open_token = function (raw_token) {
    ...
    parser_token.is_unformatted =
      !parser_token.tag_complete &&
      in_array$2(parser_token.tag_check, this._options.unformatted);
    parser_token.is_content_unformatted =
      !parser_token.is_empty_element &&
      in_array$2(parser_token.tag_check, this._options.content_unformatted);
    parser_token.is_inline_element =
      in_array$2(parser_token.tag_name, this._options.inline) ||
  ...
  function style_html(html_source, options, js_beautify, css_beautify) {
    var beautifier = new Beautifier$5(
      html_source,
      options,
      js_beautify,
      css_beautify
...
**/
  ...
  function getSelector(selector, methodName) {
    ...
    if (type === INVALID_SELECTOR) {
      throwError(
        "wrapper." +
          methodName +
          "() must be passed a valid CSS selector, Vue " +
  ...
  WrapperArray.prototype.exists = function exists() {
    return (
      this.length > 0 &&
      this.wrappers.every(function (wrapper) {
  ...
  WrapperArray.prototype.throwErrorIfWrappersIsEmpty =
    function throwErrorIfWrappersIsEmpty(method) {
  ...
  WrapperArray.prototype.setData = function setData(data) {
    ...
    return Promise.all(
      this.wrappers.map(function (wrapper) {
  ...
  ErrorWrapper.prototype.at = function at() {
    throwError(
      "find did not return " +
        buildSelectorString(this.selector) +
  ...
  Wrapper.prototype.classes = function classes(className) {
    ...
    if (this.vm && this.vm.$style) {
      var cssModuleIdentifiers = Object.keys(this.vm.$style).reduce(function (
        acc,
        key
      ) {
        // $FlowIgnore
  ...
  Wrapper.prototype.get = function get(rawSelector) {
    ...
    if (found instanceof ErrorWrapper) {
      throw new Error(
        "Unable to find " + rawSelector + " within: " + this.html()
      );
    }
    return found;
  };
  ...
  Wrapper.prototype.getComponent = function getComponent(rawSelector) {
    ...
    if (found instanceof ErrorWrapper) {
      throw new Error(
        "Unable to get " + rawSelector + " within: " + this.html()
      );
    }
    return found;
  };
   ...
   * the provided selector.
   */
  Wrapper.prototype.findAllComponents = function findAllComponents(
    rawSelector
  ) {
    this.__warnIfDestroyed();
  ...
  Wrapper.prototype.overview = function overview() {
    ...
    var computed = this.vm._computedWatchers
      ? formatJSON.apply(
          // $FlowIgnore
          void 0,
          Object.keys(this.vm._computedWatchers).map(function (computedKey) {
            var obj;
      ...
      ? formatJSON.apply(
          // $FlowIgnore
          void 0,
          Object.entries(this.vm.$options.computed).map(function (ref) {
            var obj;
  ...
  Wrapper.prototype.setData = function setData(data) {
    if (this.isFunctionalComponent) {
      throwError(
        "wrapper.setData() cannot be called on a functional component"
      );
    }
    ...
    Object.keys(data).forEach(function (key) {
      ...
      if (
        ...
        throwError(
          "wrapper.setProps() called with the same object of the existing " +
            key +
            " property. You must call wrapper.setProps() with a new " +
      ...
      if (
        ...
        (!this$1.vm ||
          ...
          !this$1.vm.$options._propKeys.some(function (prop) {
            return prop === key;
          }))
      ) {
        throwError(
          "wrapper.setProps() called with " +
            key +
            " property which " +
   ...
   */
  Wrapper.prototype.__simulateTrigger = function __simulateTrigger(
    type,
    options
  ) {
    var this$1 = this;
  ...
  var VueWrapper = /*@__PURE__*/ (function (Wrapper) {
    function VueWrapper(vm, options) {
      ...
      Object.defineProperty(this, "rootNode", {
        get: function () {
          return vm.$vnode || { child: this$1.vm };
        },
        set: function () {
          return throwError("wrapper.vnode is read-only");
        },
  ...
  function _createLocalVue(_Vue, config) {
    ...
    instance.config.optionMergeStrategies =
      Vue__default["default"].config.optionMergeStrategies;
  ...
  function vueExtendUnsupportedOption(option) {
    return (
      ...
      "You can set " +
      option +
      " to false to mount the component."
    );
  }
  ...
  function shallowMount(component, options) {
    ...
    return mount(component, Object.assign({}, options, { shouldProxy: true }));
  }
